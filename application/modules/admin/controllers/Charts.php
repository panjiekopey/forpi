...
class Charts extends Admin_Controller {
	...
	public function __construct()
	{
		...
		$data['home'] = 'admin/'.strtolower(__CLASS__).'/';
		$this->load->vars($data);
	}
	...
	public function categories()
	{
		...
		$this->highcharts->render_to('g_render'); // choose a specific div to render to graph
	...
	* Output data as array on json string
	...
	/**
	 * pie public function.
	 * Draw a Pie, and run javascript callback public functions
	 *
	 * @access public
	 * @return void
	 */
	public function pie()
	{
		...
		$callback = "public function() { return '<b>'+ this.point.name +'</b>: '+ this.y +' %'}";
	...
	/**
	 * _ar_data public function.
	 * simulate Active Record result
	 */
	public function _ar_data()
	{
		$data = $this->_data();
