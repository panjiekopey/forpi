...
class Form {
	 ...
	 */
	public function bs3_text($label, $name, $value = NULL, $extra = array(), $icon = NULL)
	{
		$extra['class'] = 'form-control';
		return form_label($label, $name).'<div class="form-group has-feedback">'.$this->field_text($name, $value, $extra).'<span class="glyphicon '.$icon.' form-control-feedback"></span></div>';
	}

	public function bs3_email($label, $name = 'email', $value = NULL, $extra = array())
	{
		$extra['class'] = 'form-control';
		return form_label($label, $name).'<div class="form-group has-feedback">'.$this->field_email($name, $value, $extra).'<span class="glyphicon glyphicon-envelope form-control-feedback"></span></div>';
	}

	public function bs3_password($label, $name = 'password', $value = NULL, $extra = array())
	{
		$extra['class'] = 'form-control';
		return form_label($label, $name).'<div class="form-group has-feedback">'.$this->field_password($name, $value, $extra).'<span class="glyphicon glyphicon-lock form-control-feedback"></span></div>';
	}

	public function bs3_textarea($label, $name, $value = NULL, $extra = array())
	{
		$extra['class'] = 'form-control';
		return form_label($label, $name).'<div class="form-group">'.$this->field_textarea($name, $value, $extra).'</div>';
	}
